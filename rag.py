...
- own_work: asking about who the author is, what the title is, who supervised the research, when was it submitted, Jayesh Kumeriya's work — his research, project, dissertation, thesis, study, model, system, results, architecture, contributions, findings, achievements. Includes generic phrases like "this research", "the project", "this work", "this study", "the paper", "the system" when context implies it's about the assistant's own subject matter. When in doubt, prefer own_work over general.
